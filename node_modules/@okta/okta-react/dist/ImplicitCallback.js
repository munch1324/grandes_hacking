  ...
  (0, _createClass3.default)(ImplicitCallback, [{
    ...
    value: function componentDidMount() {
      ...
      this.props.auth.handleAuthentication().then(function () {
        var location = _this2.props.auth.getFromUri();
        _this2.setState({ authenticated: true, location: location });
      }).catch(function (err) {
    ...
    value: function render() {
      ...
      if (authenticated && location) {
        return _react2.default.createElement(_reactRouter.Redirect, { to: location });
      }
